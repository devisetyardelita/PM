...
if ( ! function_exists( 'sparkle_fse_footer_copyright' ) ){
    ...
    function sparkle_fse_footer_copyright() {
        ...
        echo esc_html( apply_filters( 'construction_light_copyright_text', $content = esc_html__('Copyright  &copy; ','sparkle-fse') . date( 'Y' ) . ' ' . get_bloginfo( 'name' ) .' - ' ) );
